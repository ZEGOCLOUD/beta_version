  ...
  Future<ZegoSignalingPluginSendInvitationResult> sendInvitation({
    ...
    return ZIM
      ...
      return ZegoSignalingPluginSendInvitationResult(
        ...
        errorInvitees: Map.fromIterable(
          zimResult.info.errorInvitees,
          key: (element) => (element as ZIMCallUserInfo).userID,
          value: (element) => ZegoSignalingPluginCallUserState
              .values[(element as ZIMCallUserInfo).state.index],
        ),
      );
    }).catchError((error) {
      return ZegoSignalingPluginSendInvitationResult(
