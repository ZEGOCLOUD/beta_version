  ...
  Future<ZegoSignalingPluginQueryUsersInRoomAttributesResult>
    ...
    return ZIM
      ...
      return ZegoSignalingPluginQueryUsersInRoomAttributesResult(
        ...
        attributes: Map.fromIterable(
          zimResult.infos,
          key: (element) => (element as ZIMRoomMemberAttributesInfo).userID,
          value: (element) =>
              (element as ZIMRoomMemberAttributesInfo).attributes,
        ),
      );
    }).catchError((error) {
      return ZegoSignalingPluginQueryUsersInRoomAttributesResult(
  ...
  Future<ZegoSignalingPluginSetUsersInRoomAttributesResult>
    ...
    return ZIM
      ...
      return ZegoSignalingPluginSetUsersInRoomAttributesResult(
        ...
        errorKeys: Map.fromIterable(
          zimResult.infos,
          key: (element) => (element as ZIMRoomMemberAttributesOperatedInfo)
              .attributesInfo
              .userID,
          value: (element) =>
              (element as ZIMRoomMemberAttributesOperatedInfo).errorKeys,
        ),
        attributes: Map.fromIterable(
          zimResult.infos,
          key: (element) => (element as ZIMRoomMemberAttributesOperatedInfo)
              .attributesInfo
              .userID,
          value: (element) => (element as ZIMRoomMemberAttributesOperatedInfo)
              .attributesInfo
              .attributes,
        ),
      );
